...
// on Saturday, 13-Feb-2021 11:48:34 EST 
...
class clsactivity extends clsUtil {
  ...
  public function Create () {
    ...
    $SQL = "INSERT INTO activity (RecID) VALUES (?)";
  ...
  public function Delete () {
    ...
    $SQL = "DELETE FROM activity WHERE RecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
  ...
  public function Update () {
    ...
    $SQL = "UPDATE activity SET Name = ? WHERE RecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("ss", $this->Name,$this->RecID);
    $S->execute();
    $S->close();  
  ...
  public function FindByID ($ID) {
    ...
    $SQL = "SELECT RecID, Name FROM activity WHERE RecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("s", $ID);
    ...
    $S->execute();
    $S->store_result();
    $S->bind_result($this->RecID, $this->Name);
  ...
  public function FindByQuery ($SQL, $ArrayArgs) {
    ...
    $SQL = "SELECT RecID, Name FROM " . $SQL;
    ...
    $this->_S->bind_result($this->RecID, $this->Name);
